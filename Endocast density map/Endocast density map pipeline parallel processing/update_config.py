...
# Define directories
data_dir = "J:/Samples/All human/Endocast density map pipeline parallel processing/Data"
results_dir = "J:/Samples/All human/Endocast density map pipeline parallel processing/Results"
reference_dir = os.path.join(data_dir, "Reference")
visualisations_dir = "J:/Samples/All human/Endocast density map pipeline parallel processing/Visualisations"

# Define file patterns
brain_scans_pattern = os.path.join(data_dir, "*.nii")
sulci_curves_pattern = os.path.join(data_dir, "*_curves.csv")  # Adjust this pattern to match your sulci files
ref_surface_file = os.path.join(reference_dir, "B_F_40y_2542_mirror_resampled_mirrored_aligned_scaled.vtk")  # Adjust to your reference surface filename
